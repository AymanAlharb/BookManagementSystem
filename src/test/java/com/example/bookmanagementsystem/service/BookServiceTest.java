...
public class BookServiceTest {
    ...
    private CreatingBookRequest creatingBookRequest2;
    ...
    void init(){
        ...
        creatingBookRequest2 = CreatingBookRequest.builder()
                .title("test3")
                .authorName("t1")
                .description("welcome to test1")
                .build();
    ...
    public void BookService_AddBook_ReturnsBook(){
        ...
        assertEquals(creatingBookRequest.getTitle(), book1.getTitle());
    }
